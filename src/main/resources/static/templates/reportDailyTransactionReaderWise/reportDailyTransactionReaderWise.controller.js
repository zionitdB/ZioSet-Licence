(function() {
	...
	angular.module('myApp.reportDailyTransactionReaderWise').controller('ReportDailyTransactionReaderWiseController', ReportDailyTransactionReaderWiseController);

	ReportDailyTransactionReaderWiseController.$inject = [ '$state', '$uibModal','genericFactory', '$log','$scope', 'toastr' , 'localStorageService', 'ApiEndpoint','$window','$rootScope','$http','$filter','$stateParams'];
	
	/* @ngInject */
	function ReportDailyTransactionReaderWiseController($state,$uibModal, genericFactory, $log, $scope, toastr, localStorageService, ApiEndpoint,$window,$rootScope,$http,$filter,$stateParams) {
		...
		function getData(){
			...
			var url =reportUrl+"/getDailyTransactionByReadetAndDate";
			var msg=""
				var obj={}
			
			obj.deviceID=vm.device.deviceId
