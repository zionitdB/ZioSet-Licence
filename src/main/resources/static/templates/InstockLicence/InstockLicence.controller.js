(function() {
	...
	angular.module('myApp.InstockLicence').controller('InstockLicenceController', InstockLicenceController);

	InstockLicenceController.$inject = [ '$state', '$uibModal','genericFactory', '$log','$scope', 'toastr' , 'localStorageService', 'ApiEndpoint','$window','$rootScope','$http','$filter','$stateParams'];
	
	/* @ngInject */
	function InstockLicenceController($state,$uibModal, genericFactory, $log, $scope, toastr, localStorageService, ApiEndpoint,$window,$rootScope,$http,$filter,$stateParams) {
		...
		function loadLicence(){
			var msg=""
			 ...
			 var url =licenceUrl+"/getInstockLicences";
