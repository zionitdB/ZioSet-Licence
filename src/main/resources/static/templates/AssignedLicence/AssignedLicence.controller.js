(function() {
	...
	angular.module('myApp.AssignedLicence').controller('AssignedLicenceController', AssignedLicenceController);

	AssignedLicenceController.$inject = [ '$state', '$uibModal','genericFactory', '$log','$scope', 'toastr' , 'localStorageService', 'ApiEndpoint','$window','$rootScope','$http','$filter','$stateParams'];
	
	/* @ngInject */
	function AssignedLicenceController($state,$uibModal, genericFactory, $log, $scope, toastr, localStorageService, ApiEndpoint,$window,$rootScope,$http,$filter,$stateParams) {
		...
		function loadLicence(){
			var msg=""
			 ...
			 var url =licenceUrl+"/getAssignedLicences";
